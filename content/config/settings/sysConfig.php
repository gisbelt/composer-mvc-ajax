...
define("_ROUTE_" , "http://localhost/composer-mvc-ajax/");					/* direccion del proyecto */
define("_THEME_" , "http://localhost/composer-mvc-ajax/assets");			/* Direccion de recursos y estilos */
define("_INDEX_FILE_" , "http://localhost/composer-mvc-ajax/index.php");	/* direccion del archivo index */
...
define("_DB_WEB_" , "practica");								/* nombre de la base de datos */
